...
import { compatibleDevices, skuOffer, skuPackages } from '@/lib/storeReadModel';
...
export function OfferBuyPage() {
  ...
  const sku = data?.skus.find((item) => item.id === id); const offer = data && sku ? skuOffer(data, sku.id) : null;
