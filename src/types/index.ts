...
export interface WatchFaceElement {
  id: string;
  version?: number;
  type: 'TIME_POINTER' | 'TIME_READING' | 'GAUGE_POINTER' | 'IMG_LEVEL' | 'TEXT' | 'IMG' | 'SHORTCUT_ICON' | 'ARC_PROGRESS' | 'CIRCLE' | 'TEXT_IMG' | 'BUTTON' | 'IMG_STATUS' | 'IMG_TIME' | 'IMG_DATE' | 'IMG_WEEK' | 'FILL_RECT' | 'STROKE_RECT' | 'IMG_ANIM' | 'IMG_PROGRESS' | 'DATE_POINTER' | 'IMG_CLICK' | 'image_layer';
  subtype?: string;
  name: string;
  displayName?: string;
  bounds: {
