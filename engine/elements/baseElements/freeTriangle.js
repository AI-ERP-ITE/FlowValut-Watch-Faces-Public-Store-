...
export function renderFreeTriangle(params = {}, position = {}, context = {}) {
	...
	const points = buildPoints([p.side1, p.side2, p.side3], p.rotation, baseRadius, scale);

	return `<polygon points="${points}" fill="${fill}" stroke="${stroke}" stroke-width="${strokeWidth}" />`;
}

export const freeTriangleElement = {
	id: "free_triangle",
	geometry: { type: "rect" },
	defaultParams: { ...DEFAULTS },
	render: renderFreeTriangle,
};
