import{j as e,L as o}from"./index-DrkmS9U2.js?v=checkout-7fcd5f9";import{L as r,b as i,a as n}from"./LegalLayout-CDUTckfu.js?v=checkout-92ef0ea";const t=`
...
`;function c(){return e.jsxs(r,{title:"Legal Notices",description:"Company information, governing law, merchant of record, and index of all legal documents.",content:t,children:[e.jsxs("section",{className:"mb-10",children:[e.jsx("h2",{className:"text-lg font-semibold text-[#dce3ee] mb-4",children:"Legal Document Index"}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:i.filter(a=>a.to!=="/legal").map(a=>e.jsxs(o,{to:a.to,className:"flex items-center gap-3 rounded-lg border border-[#1e2a3a] bg-[#0d1117] px-4 py-3 hover:border-[#3a5070] hover:bg-[#111a26] transition-colors group",children:[e.jsx("span",{className:"text-[#c4aa7a] text-sm",children:"→"}),e.jsx("span",{className:"text-sm text-[#9ba6b8] group-hover:text-[#e9edf5] transition-colors",children:a.label})]},a.to))})]}),e.jsx(n,{content:t})]})}export{c as LegalIndexPage};
