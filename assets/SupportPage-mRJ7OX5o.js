...
## 2. Automated Purchase Recovery

Before contacting support, purchasers should use the protected recovery link in their FlowVault delivery email or submit the Paddle order ID together with the exact original checkout email. Recovery is automated for seven (7) days. Each purchased ZPK package has two initial successful transfers and one regenerated successful transfer, with an absolute maximum of three. QR and direct-link delivery share that allowance. A different email cannot recover or take ownership of the order.
...
## 5. Product Lifecycle and End-of-Support
...
`;function s(){return e.jsx(i,{title:"Support Policy",description:"How to get help, our response commitments, and what we support.",version:"1.1",lastUpdated:"August 9, 2026",content:t,children:e.jsx(a,{content:t})})}export{s as SupportPage};
